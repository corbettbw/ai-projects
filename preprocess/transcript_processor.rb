...
def process_transcript(cleaned_transcript_file_name)
  # Read the transcript file
  transcript_file = "data/cleaned_transcripts/#{cleaned_transcript_file_name}.txt"
  ...
  output_file = "data/processed_transcripts/#{cleaned_transcript_file_name}.json"
  File.write(output_file, json_data)
  
  puts "Transcript data has been processed and saved to #{output_file}."
  return cleaned_transcript_file_name
end
