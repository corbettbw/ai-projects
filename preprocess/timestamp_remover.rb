...
def remove_timestamps(original_transcript_name)
  # Read the input transcript file
  input_file_path = "data/original_transcripts/#{original_transcript_name}.txt"
  output_file_path = "data/cleaned_transcripts/cleaned_#{original_transcript_name}.txt"
  ...
  puts "Timestamps removed and transcript formatted as requested. Cleaned transcript saved to '#{output_file_path}'."
  return "cleaned_#{original_transcript_name}"
end
